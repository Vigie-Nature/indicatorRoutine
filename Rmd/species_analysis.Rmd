...
sumAnnualOcc = params$sumAnnualOcc
...
:::
\
*Les catégories de tendances sont basées sur les critères de l'EBCC ou de l'UICN. Cf. détail des critères en p3.*
\
\newpage
*Table des occurrences annuelles (nombre de sites où l'espèce a été observée) et des abondances annuelles (nombre d'individus contactés dans l'ensemble des sites)*
```{r fig.align = "center", echo = FALSE}
`%>%` = magrittr::`%>%`

kableExtra::kbl(sumAnnualOcc, align = "c", booktabs = T, centering = T, longtable = TRUE) %>%
  kableExtra::row_spec(0, color = "#E68146", bold = T, font_size = 11) %>%
  kableExtra::row_spec(1:nrow(sumAnnualOcc), color = "#E68146", font_size = 11) %>%
  kableExtra::column_spec(2, width = '2.5cm') %>%
  kableExtra::column_spec(3, width = '2cm')
