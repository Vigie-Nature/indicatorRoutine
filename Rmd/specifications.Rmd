...
kableExtra::kable(dataSpecLT[,colnames(dataSpecLT) != "modelName"]) %>%
  kableExtra:: kable_paper(c("striped", "condensed", "hover"), fixed_thead = T) %>%
...
kableExtra::kable(dataSpecST[,colnames(dataSpecST) != "modelName"]) %>%
  kableExtra:: kable_paper(c("striped", "condensed", "hover"), fixed_thead = T) %>%
  kableExtra::scroll_box(width = "1000px", height = "300px")
```
...
kableExtra::kable(dataSpecVar[,colnames(dataSpecVar) != "modelName"]) %>%
  kableExtra:: kable_paper(c("striped", "condensed", "hover"), fixed_thead = T) %>%
  kableExtra::scroll_box(width = "1000px", height = "300px")
```